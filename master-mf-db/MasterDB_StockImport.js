...
function onOpen() {
  ...
  ui.createMenu('📋 Stock Screener')
    ...
    .addItem('🔄 Refresh Trendlyne Data', 'menuRefreshTrendlyne')
    .addItem('🔄 Refresh Nifty Data', 'menuRefreshNifty')
    .addItem('📈 Re-score Watchlist', 'menuRescoreWatchlist')
    .addItem('🚀 Full Pipeline (Trendlyne → Nifty → Score)', 'menuFullPipeline')
    .addSeparator()
    .addItem('🗑️ Clear & Re-fetch Watchlist', 'menuClearAndRefetchWatchlist')
