...
const target = `  // Use Drive API via UrlFetchApp to create the spreadsheet using ONLY drive.file scope.
...
const replacement = `  var spreadsheet = SpreadsheetApp.create('Capital Friends - ' + name);`;
